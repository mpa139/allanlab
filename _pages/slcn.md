...
<button  onclick="window.location.href='https://slcn.grand-challenge.org/';">Data Access</button> <button name="button">Data Description</button>  <button name="button">Cortical Surface Tools</button>  <button name="button">Repositories</button>  <button name="button">Timeline</button>
