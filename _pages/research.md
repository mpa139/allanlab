...
![]({{ site.url }}{{ site.baseurl }}/images/respic/network_detail.png){: style="width: 200px; float: left; margin: 0px 10px"} **Discovering Persuasive Concepts Related to Renewable Energy Using Deep Neural Networks Molly Roberts, Megan Ayers, Kevin Li, Luke Sanford**
...
![]({{ site.url }}{{ site.baseurl }}/images/respic/ex8.png){: style="width: 200px; float: left; margin: 0px 10px"} **Using remote sensing to improve causal impact evaluation. Luke Sanford, Charles Xu, Jackson Pullman**
