...
<div markdown="0" id="carousel" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover" >
    ...
    <div class="carousel-inner" markdown="0">
        ...
        <div class="item">
         ...
         <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/slider7001400/BSCCOgap2.jpg" alt="Slide 6" />
        </div>
    </div>
...
We are very much looking forward to being part of LMU physics! We will build up our instruments right in the center of the city, including the “Sommerfeldkeller”, where Sommerfeld himself worked. We will exchange ideas with world class groups working in quantum physics, cold-atom many-body physics, and 2d quantum materials.
