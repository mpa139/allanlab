...
We are grateful for funding from Yale University, the Yale Environmental Data Science Initiative, the [Brown Climate Social Sciences Network](https://cssn.org/), [The Yale Center for Natural Carbon Capture](https://naturalcarboncapture.yale.edu/) and the [Planetary Solutions Project](https://planetarysolutions.yale.edu/) .

<figure class="text-center">
  <img src="{{ site.url }}{{ site.baseurl }}/images/logopic/YSE_logo.png" style="width: 150px">
  <img src="{{ site.url }}{{ site.baseurl }}/images/logopic/yale.png" style="width: 150px">
<!--   <img src="{{ site.url }}{{ site.baseurl }}/images/logopic/Logo_ERC.jpg" style="width: 110px"> -->
</figure>
