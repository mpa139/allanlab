...
![]({{ site.url }}{{ site.baseurl }}/images/respic/research1.png){: style="width: 70%; float: right; margin: 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/respic/research2.JPG){: style="width: 70%; float: right; margin: 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/respic/research3.JPG){: style="width: 70%; float: right; margin: 10px"}
